...
RSpec.describe Trip, type: :model do
  it "is a valid Trip" do
    trip = Trip.create(title: "Vegas Baby!", start_date: "2014-10-30", end_date: "2014-10-31" )
    expect(trip).to be_valid
  end

  it "is not a valid Trip" do
    trip = Trip.create(title: nil, start_date: "2014-10-30", end_date: "2014-10-31")
    expect(trip).not_to be_valid
  end

  it "is not a valid Trip" do
    trip = Trip.create(title: "Vegas Baby!, Baby?, I'm prego", start_date: nil, end_date: "2014-10-31")
    expect(trip).not_to be_valid
  end

  it "is not a valid Trip" do
    trip = Trip.create(title: "Vegas Baby!", start_date: "2014-10-30", end_date: nil)
    expect(trip).not_to be_valid
  end
